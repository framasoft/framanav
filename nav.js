...
var n$ = {
  ...
  if (!n$.inframe) {
    ...
    tonality = f$Md5(n$.url).substring(0,8);
    concerto = n$.url.split(/[?#]/)[0].substring(n$.url.lastIndexOf('/')+1).replace(/[^a-zA-Z0-9=\?]/g, '');
    ...
    n$.maestro =
      ...
      '0,'+(currentW + 40)+','+talkW+','+talkH+','+encodeURIComponent('https://framatalk.org/'+tonality+concerto)+';';
  }

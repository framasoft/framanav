            ...
            <div class="navbar  <?php echo FNAV_STATIC==true ? 'navbar-fixed-top' : ''; ?>" id="framanav">
              <div class="navbar-inner">
                ...
                <div class="framanav_container">
                  ...
                  <div class="nav-collapse collapse">  <!-- automatiquement refermé en cas de petit écran -->
                    <ul class="nav">

                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Logiciel libre <b class="caret"></b></a>
                        <ul class="dropdown-menu">
							<li><a href="http://framasoft.org" rel="popover" data-content="Le réseau Framasoft" title="Framasoft"><i class="icon-home"></i>&nbsp;Framasoft</a></li>
							<li class="divider"></li>
							...
							<li><a href="http://framakey.org" rel="popover" data-content="Applications nomades pour clés USB. <div class='framanav_scr framanav_framakey'></div>" title="Framakey"><img src="<?php echo FNAV_RPATH; ?>/img/small_usb.png" />&nbsp;Framakey</a></li>
	                          </ul>
                      </li>											
                       ...
                       <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li><a href="http://framalang.org" rel="popover" data-content="Collection de livres libres.  <div class='framanav_scr framanav_framalang'></div>" title="Framalang"><i class="icon-book"></i>&nbsp;Framalang</a></li>
                      		<li><a href="http://framatube.org" rel="popover" data-content="Les vidéos du libre.<div class='framanav_scr framanav_framatube'></div>" title="Framatube"><i class="icon-facetime-video"></i>&nbsp;Framatube</a></li>
                       ...
                       <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li><a href="http://framaphonie.org" rel="popover" data-content="Diffusion de produits libres dans les zones faiblement connectées. <div class='framanav_scr framanav_framaphonie'></div>" title="Framaphonie"><i class="icon-map-marker"></i>&nbsp;Framaphonie</a></li>
                       ...
                       <li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="http://framacode.org" rel="popover" data-content="Télécharger nos applications ou contribuer à leur développement.<div class='framanav_scr framanav_framacode'></div>" title="Framacode"><i class="icon-wrench"></i>&nbsp;Framacode</a></li>
								...
								<li><a href="http://soutenir.framasoft.org" rel="popover" data-content="Framasoft ne vit que grâce à vos dons.<br/>Soutenez-nous ! <div class='framanav_scr framanav_soutenir'></div>" title="Faire un don"><i class="icon-gift"></i>&nbsp;Faire un don</a></li>
								<li class="divider"></li>
								...
								<li><a href="http://planet-libre.org" rel="popover" data-content="Sélection de nouvelles du libre francophone.<div class='framanav_scr framanav_planete'></div>" title="Planet-libre"><i class="icon-globe"></i>&nbsp;Planete-libre</a></li>
					...
					<form class="navbar-search pull-right" action="http://www.google.com/cse"> 
						<input type="hidden" value="017931506014566040656:iqp-lrqbqlu" name="cx"/> 
					...
					<script src="http://www.google.com/coop/cse/brand?form=searchbox_017931506014566040656%3Aiqp-lrqbqlu&amp;lang=fr" type="text/javascript"></script>
                    ...
                    <ul class="nav pull-right">
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li><a href="http://soutenir.framasoft.org/newsletter" data-content="Rejoignez nos 5000 abonnés à notre lettre d'informations." title="Lettre d'informations"><i class="icon-bullhorn"></i>&nbsp;Newsletter</a></li>
							<li><a href="http://framapack.org/~framaflux/rss.php"  data-content="Flux RSS agrégé des différents sites." title="Flux RSS"><img src="<?php echo FNAV_RPATH; ?>/img/small_rss.png" />&nbsp;Flux RSS</a></li>
				...
				<!-- /automatiquement refermé en cas de petit écran -->
                  </div>
                </div>
              </div><!-- /navbar-inner -->
            </div><!-- /navbar -->

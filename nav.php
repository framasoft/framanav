                      ...
                      <li class="dropdown">
                       ...
                       <li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="http://framacode.org" rel="popover" data-content="T&eacute;l&eacute;charger nos applications ou contribuer &acute; leur d&eacute;veloppement.<div class='framanav_scr framanav_framacode'></div>" title="Framacode"><i class="icon-wrench"></i>&nbsp;Framacode</a></li>
                    ...
                    <ul class="nav pull-right">
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li><a href="http://soutenir.framasoft.org/newsletter" data-content="Rejoignez nos 5000 abonn&eacute;s &acute; notre lettre d'informations." title="Lettre d'informations"><i class="icon-bullhorn"></i>&nbsp;Newsletter</a></li>

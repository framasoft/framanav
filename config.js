...
switch (f$_site) {
    ...
    case 'framadrive':
        ...
        if( (f$_page('index.php/app') && !f$_page('registration')) || f$_page('index.php/setting')) {
            ...
            f$_video_js = true;
            f$_alert_type = 'info';
            f$_alert_cookie_name = 'drive-update2';
            f$_alert_text =
            '<div style="margin:0 auto; max-width:800px;">'+
                '<p class="text-center">Attention, Framadrive sera en maintenance jeudi 26/11 dès 18h50. La coupure devrait durer quelques heures. Plus d’infos sur <a href="https://status.framasoft.org/">status.framasoft.org</a>.</p>'+
            '</div>';
        }
    break;
    case 'framagames':

<template>
  <portal target-el="#fp-footer" target-class="f-bs4">
    <footer id="f-footer"
            ...
            <form action="https://contact.framasoft.org/php_list/lists/?p=subscribe&amp;id=2"
              ...
              <b-input-group size="sm" class="mb-3">
                ...
                <b-input-group-append>
                  <b-button variant="dark" name="subscribe" type="submit" value="subscribe">
                    <span v-html="$t('txt.subscribe')"></span>
                    <span class="sr-only" v-html="$t('txt.toTheNewsletter')"></span>
                  </b-button>
                </b-input-group-append>
              </b-input-group>

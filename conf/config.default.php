...
# Doit-on charger un fichier CSS suppl�mentaire ?
# Par d�faut � false
# Sinon, chemin du fichier. ex: define("FNAV_EXTEND_CSS", FNAV_RPATH."/extra.css");
myDefine("FNAV_EXTRA_CSS", false);

# Ajout de code sp�cifique en d�but de nav (cf $fnav_extra_start)
myDefine("FNAV_EXTRA_START", false);

# Ajout de code sp�cifique en fin de nav (cf $fnav_extra_end)
...
$fnav_extra_alert_modal_force = "true"; //forcer l'affichage de la fenetre � la premi�re visite
$alert_cookie_time = 0.05; // dur�e du cookie, en heures.
$fnav_extra_alert_txt_title = "Attention, ce site sera bientot mis-�-jour !"; // contenu par d�faut du contenu de l'alerte sous la nav.
...
# Par d�faut : dirname(__FILE__)."/alert_title.txt"; 
...
# Par d�faut : dirname(__FILE__)."/alert_content.txt"; 
...
# Si on a d�fini FNAV_EXTRA_ALERT_TXT_FILES a "true", on charge les fichiers distants
